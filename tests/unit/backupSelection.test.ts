...
import {
  selectedFromSkipMongoNames,
  skipMongoNamesFromPreview,
} from '../../src/utils/backupSelection.js'

function mockPreview(groups: BackupSourcePreviewResponse['groups']): BackupSourcePreviewResponse {
  return {
    groups,
